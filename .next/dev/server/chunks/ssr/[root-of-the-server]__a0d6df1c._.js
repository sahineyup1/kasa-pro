...
function SuppliersPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setLoading(true);
        const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["subscribeToRTDB"])('partners', (data)=>{
            setSuppliers(data || []);
            setLoading(false);
        });
        return ()=>unsubscribe();
    ...
    const handleToggleStatus = async (supplier)=>{
        try {
            ...
            if (supplier.basic) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["updateData"])(`partners/${supplier.id}/basic`, {
                    isActive: newStatus
                });
            } else {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["updateData"])(`partners/${supplier.id}`, {
                    isActive: newStatus,
                    updatedAt: new Date().toISOString()
                });
            }
    ...
    const handleDelete = async (supplier)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["removeData"])(`partners/${supplier.id}`);
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a0d6df1c._.js.map