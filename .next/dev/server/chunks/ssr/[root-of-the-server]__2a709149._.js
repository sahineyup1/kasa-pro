...
"[project]/src/components/dialogs/employee-dialog.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getField(employee, nestedPath, flatKey, defaultVal) {
    ...
    const flatValue = employee[flatKey];
    if (flatValue !== undefined && flatValue !== null) return flatValue;
    return defaultVal;
}
function EmployeeDialog({ open, onOpenChange, employee, onSave }) {
    ...
    const [nationality, setNationality] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    // Employment info
    const [role, setRole] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('kasiyer');
    ...
    // Documents
    const [visaExpiry, setVisaExpiry] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const [workPermitExpiry, setWorkPermitExpiry] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [taxNumber, setTaxNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    // Notes
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (open) {
            ...
            if (employee) {
                ...
                setFirstName(getField(employee, [
                    'personal',
                    'firstName'
                ], 'firstName', ''));
                setLastName(getField(employee, [
                    'personal',
                    'lastName'
                ], 'lastName', ''));
                setPhone(getField(employee, [
                    'personal',
                    'phone'
                ], 'phone', ''));
                setEmail(getField(employee, [
                    'personal',
                    'email'
                ], 'email', ''));
                setAddress(getField(employee, [
                    'personal',
                    'address'
                ], 'address', ''));
                setDateOfBirth(getField(employee, [
                    'personal',
                    'dateOfBirth'
                ], 'dateOfBirth', ''));
                setNationality(getField(employee, [
                    'personal',
                    'nationality'
                ], 'nationality', ''));
                setRole(getField(employee, [
                    'employment',
                    'role'
                ], 'role', 'kasiyer'));
                setBranch(getField(employee, [
                    'employment',
                    'branch'
                ], 'branch', ''));
                setSalary(String(getField(employee, [
                    'employment',
                    'salary'
                ], 'salary', '') || ''));
                setStatus(getField(employee, [
                    'employment',
                    'status'
                ], 'status', 'active'));
                setStartDate(getField(employee, [
                    'employment',
                    'startDate'
                ], 'startDate', ''));
                setVisaExpiry(getField(employee, [
                    'documents',
                    'visaExpiry'
                ], 'visaExpiry', ''));
                setWorkPermitExpiry(getField(employee, [
                    'documents',
                    'workPermitExpiry'
                ], 'workPermitExpiry', ''));
                setNationalId(getField(employee, [
                    'documents',
                    'nationalId'
                ], 'nationalId', ''));
                setTaxNumber(getField(employee, [
                    'documents',
                    'taxNumber'
                ], 'taxNumber', ''));
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            if (isEditMode && employee?.id) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["updateFirestoreData"])('employees', employee.id, employeeData);
            } else {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["addFirestoreData"])('employees', {
                    ...employeeData,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogHeader"], {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogTitle"], {
                            ...
                            children: isEditMode ? 'Personel Duzenle' : 'Yeni Personel'
                        }, void 0, false, {
                            fileName: "[project]/src/components/dialogs/employee-dialog.tsx",
                            lineNumber: 269,
                            columnNumber: 11
                        }, this),
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "text-sm text-gray-500 mt-1",
                            children: isEditMode ? 'Personel bilgilerini guncelleyin' : 'Yeni personel eklemek icin formu doldurun'
                        }, void 0, false, {
                            fileName: "[project]/src/components/dialogs/employee-dialog.tsx",
                            lineNumber: 272,
                            columnNumber: 11
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: [
                                                ...
                                                " Vize ve calisma izni bitis tarihleri yaklastikca sistem sizi uyaracaktir."
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/components/dialogs/employee-dialog.tsx",
                                            lineNumber: 445,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/services/firebase.ts [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dialogs$2f$employee$2d$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/dialogs/employee-dialog.tsx [app-ssr] (ecmascript)");
...
function VisaBadge({ expiryDate }) {
    if (!expiryDate) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
function EmployeesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setLoading(true);
        const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["subscribeToFirestore"])('employees', (data)=>{
            setEmployees(data || []);
            setLoading(false);
        });
        return ()=>unsubscribe();
    ...
    const filteredEmployees = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        return employees.filter((employee)=>{
            // Search filter
            const firstName = getField(employee, [
                'personal',
                'firstName'
            ], 'firstName', '');
            const lastName = getField(employee, [
                'personal',
                'lastName'
            ], 'lastName', '');
            const fullName = `${firstName} ${lastName}`.toLowerCase();
            const phone = getField(employee, [
                'personal',
                'phone'
            ], 'phone', '');
            const email = getField(employee, [
                'personal',
                'email'
            ], 'email', '');
            const searchLower = searchQuery.toLowerCase();
            const matchesSearch = !searchQuery || fullName.includes(searchLower) || phone.includes(searchLower) || email.toLowerCase().includes(searchLower);
            // Role filter
            const role = getField(employee, [
                'employment',
                'role'
            ], 'role', '');
            const matchesRole = roleFilter === 'all' || role === roleFilter;
            // Status filter
            const status = getField(employee, [
                'employment',
                'status'
            ], 'status', 'active');
            const matchesStatus = statusFilter === 'all' || status === statusFilter;
            // Branch filter
            const branch = getField(employee, [
                'employment',
                'branch'
            ], 'branch', '');
    ...
    // Get unique roles
    const roles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const roleSet = new Set();
        employees.forEach((e)=>{
            const role = getField(e, [
                'employment',
                'role'
            ], 'role', '');
    ...
    const handleToggleStatus = async (employee)=>{
        try {
            const currentStatus = getField(employee, [
                'employment',
                'status'
            ], 'status', 'active');
            const newStatus = currentStatus === 'active' || currentStatus === 'aktif' ? 'inactive' : 'active';
            if (employee.employment) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["updateFirestoreData"])('employees', employee.id, {
    ...
    const handleDelete = async (employee)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["deleteFirestoreData"])('employees', employee.id);
        } catch (error) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-sm text-gray-500 mt-1",
                                        children: "Calisan bilgileri, vize takibi ve maas yonetimi"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/dashboard/employees/page.tsx",
                                        lineNumber: 319,
                                        columnNumber: 13
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: [
                                                        "€",
                                                        stats.totalSalary.toLocaleString('tr-TR', {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableBody"], {
                                children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableRow"], {
                                    ...
                                    lineNumber: 467,
                                    columnNumber: 17
                                }, this) : filteredEmployees.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableRow"], {
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableCell"], {
                                        colSpan: 8,
                                        className: "text-center py-8 text-gray-500",
                                        children: searchQuery || roleFilter !== 'all' || statusFilter !== 'all' || branchFilter !== 'all' ? 'Filtrelere uygun personel bulunamadi' : 'Henuz personel eklenmemis'
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/dashboard/employees/page.tsx",
                                        lineNumber: 474,
                                        columnNumber: 19
                                    ...
                                    const salary = getField(employee, [
                                        'employment',
                                        'salary'
                                    ], 'salary', 0);
                                    const status = getField(employee, [
                                    ...
                                    const visaExpiry = getField(employee, [
                                        'documents',
                                        'visaExpiry'
                                    ], 'visaExpiry', null);
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableRow"], {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableCell"], {
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(VisaBadge, {
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DropdownMenuContent"], {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DropdownMenuItem"], {
                                                                    ...
                                                                    children: status === 'active' || status === 'aktif' ? '⏸️ Pasif Yap' : '▶️ Aktif Yap'
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/dashboard/employees/page.tsx",
                                                                    lineNumber: 540,
                                                                    columnNumber: 29
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dialogs$2f$employee$2d$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EmployeeDialog"], {
                open: dialogOpen,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2a709149._.js.map