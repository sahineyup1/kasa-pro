...
function ReportsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReportsPage.useEffect": ()=>{
            ...
            const unsubSales = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["subscribeToFirestore"])('sale_invoices', {
                "ReportsPage.useEffect.unsubSales": (data)=>{
                    setSalesData(data || []);
                }
            }["ReportsPage.useEffect.unsubSales"]);
            const unsubExpenses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["subscribeToFirestore"])('expenses', {
                "ReportsPage.useEffect.unsubExpenses": (data)=>{
                    setExpensesData(data || []);
                }
            }["ReportsPage.useEffect.unsubExpenses"]);
            const unsubProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["subscribeToFirestore"])('products', {
                "ReportsPage.useEffect.unsubProducts": (data)=>{
                    setProductsData(data || []);
                    setLoading(false);
                }
            }["ReportsPage.useEffect.unsubProducts"]);
            return ({
                "ReportsPage.useEffect": ()=>{
                    unsubSales();
                    unsubExpenses();
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReportsPage.useMemo[stats]": ()=>{
            const totalSales = salesData.reduce({
                "ReportsPage.useMemo[stats].totalSales": (sum, s)=>sum + (s.total || 0)
            }["ReportsPage.useMemo[stats].totalSales"], 0);
            const totalExpenses = expensesData.reduce({
                "ReportsPage.useMemo[stats].totalExpenses": (sum, e)=>sum + (e.grossAmount || e.amount || 0)
            }["ReportsPage.useMemo[stats].totalExpenses"], 0);
            const profit = totalSales - totalExpenses;
            const productCount = productsData.length;
            const lowStock = productsData.filter({
                "ReportsPage.useMemo[stats]": (p)=>{
                    const stock = p.stock?.totalStock || p.stock_qty || 0;
                    return stock < 10 && stock >= 0;
                }
            }["ReportsPage.useMemo[stats]"]).length;
            return {
                totalSales,
                totalExpenses,
                profit,
...
_s(ReportsPage, "RKlOhJ8M+O1J4PbHUucOGaRb49g=");
_c2 = ReportsPage;
var _c, _c1, _c2;
...
//# sourceMappingURL=src_453526d5._.js.map